...
app.
config(function ($routeProvider, $locationProvider,$httpProvider, $mdThemingProvider, $sceDelegateProvider, $mdDateLocaleProvider, $mdIconProvider, mdSteppersConfigProvider){
    ...
    $sceDelegateProvider.resourceUrlWhitelist([
      ...
      mdSteppersConfigProvider.createSteppers(mdSteppers,"true");  
