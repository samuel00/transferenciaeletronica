package br.gov.pa.sefa.transferenciaeletronica.api.rest.status;
...
import br.gov.pa.sefa.transferenciaeletronica.core.status.StatusDTO;
import br.gov.pa.sefa.transferenciaeletronica.core.status.StatusServico;
