...
@Service public class AspectManagerService {

    @Autowired private AspectManagerRepositorio aspectManagerRepositorio;

    @Autowired private IPBloqueadoService ipBloqueadoService;
    ...
    @SuppressWarnings("unchecked") public void setStatusCode(Object result) {
