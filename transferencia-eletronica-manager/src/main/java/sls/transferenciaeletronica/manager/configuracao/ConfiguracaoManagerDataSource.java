 ...
 * ConfiguracaoManagerDataSource {
 * 
 * final Logger logger =
 * LoggerFactory.getLogger(ConfiguracaoManagerDataSource.class);
 * 
 ...
 * "sls.transferenciaeletronica" }); JpaVendorAdapter vendorAdapter = new
 * HibernateJpaVendorAdapter();
 * entityManagerFactory.setJpaVendorAdapter(vendorAdapter);
 * entityManagerFactory.setJpaProperties(additionalProperties()); return
